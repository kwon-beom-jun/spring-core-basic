...
// TODO : 스프링 초기화 및 소멸전 함수 사용 - 설정 정보 (Configuration 설정에서 등록 - BeanLifeCycleTest -> LifeCycleConfig)
/**     특징
 ...
 *              - 실제 값이 (inferred) 이렇게 스트링으로 되어있음
 *
 *          이 추론 기능은 'close', 'shutdown' 라는 이름의 메서드를 자동 호출해 준다.
 *
 *          이름 그대로 메서드를 추론해서 호출해준다
